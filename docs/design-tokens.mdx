...
- `--color-surface` — Surface/card background (#ffffff)
- `--color-surface-secondary` — Secondary surface background (#f9fafb)
...
- `--color-border-hover` — Border color on hover (#d1d5db)
